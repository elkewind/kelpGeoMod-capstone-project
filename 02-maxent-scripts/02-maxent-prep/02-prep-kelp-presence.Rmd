...
```{r}
# Read in kelp data
kelp_dat <- read_csv("/capstone/kelpgeomod/new_file_structure/analysis_data/synthesized/interpolated_join.csv") %>% 
...
for (i in 1:length(kelp_list)) {
  ...
  folder_name <- paste0("/capstone/kelpgeomod/new_file_structure/analysis_data/maxent/quarter_", i)
