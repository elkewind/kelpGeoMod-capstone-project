...
st_write(aoi_shp, "/capstone/kelpgeomod/new_file_structure/03-analysis-data/maxent/quarter_1/aoi.shp")
st_write(aoi_shp, "/capstone/kelpgeomod/new_file_structure/03-analysis-data/maxent/quarter_2/aoi.shp")
st_write(aoi_shp, "/capstone/kelpgeomod/new_file_structure/03-analysis-data/maxent/quarter_3/aoi.shp")
st_write(aoi_shp, "/capstone/kelpgeomod/new_file_structure/03-analysis-data/maxent/quarter_4/aoi.shp")
```
