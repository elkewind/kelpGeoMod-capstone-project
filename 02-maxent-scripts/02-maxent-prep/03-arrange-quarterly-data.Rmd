...
aoi_shp <- st_read("/capstone/kelpgeomod/new_file_structure/raw_data/New_AOI_SBchannel_shp/New_AOI_SBchannel.shp")

# write the aoi object to a shapefile in each quarter file
st_write(aoi, "/capstone/kelpgeomod/new_file_structure/analysis_data/maxent/quarter_1/aoi.shp")
st_write(aoi, "/capstone/kelpgeomod/new_file_structure/analysis_data/maxent/quarter_2/aoi.shp")
st_write(aoi, "/capstone/kelpgeomod/new_file_structure/analysis_data/maxent/quarter_3/aoi.shp")
st_write(aoi, "/capstone/kelpgeomod/new_file_structure/analysis_data/maxent/quarter_4/aoi.shp")
```
