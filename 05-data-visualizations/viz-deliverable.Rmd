---
title: "Maps of Kelp Data, Oceanographic Factors, and Maxent Outputs"
...
sst_pal <- "-YlGnBu"
nutrient_pal <- "OrRd"
# kelp_pal <- colorNumeric("YlGn", 
#                          values(kelp_quarter1), 
...
This map shows the area of interest for this project -- the Santa Barbara Channel.

# Kelp and Oceanographic Factors 
...
amm_all <- brick("/capstone/kelpgeomod/new_file_structure/03-analysis-data/inteprolate_idw/ammonium_quarterly.tif")
...
This map has layers that can be toggled on and off. Each grid cell per layer is an average of values observed or estimated in quarter 1 across all years (2014-2022).
...
This map has layers that can be toggled on and off. Each grid cell per layer is an average of values observed or estimated in quarter 2 across all years (2014-2022).
...
This map has layers that can be toggled on and off. Each grid cell per layer is an average of values observed or estimated in quarter 3 across all years (2014-2022).
...
This map has layers that can be toggled on and off. Each grid cell per layer is an average of values observed or estimated in quarter 4 across all years (2014-2022).
...
maxent_quarter_1 <- raster("/capstone/kelpgeomod/new_file_structure/03-analysis-data/maxent/quarter_1/results/Macrocystis_pyrifera_cloglog.tif")
...
# Read in the maxent output
maxent_quarter_2 <- raster("/capstone/kelpgeomod/new_file_structure/03-analysis-data/maxent/quarter_2/results/Macrocystis_pyrifera_cloglog.tif")
...
# Read in the maxent output
maxent_quarter_3 <- raster("/capstone/kelpgeomod/new_file_structure/03-analysis-data/maxent/quarter_3/results/Macrocystis_pyrifera_cloglog.tif")
...
# Read in the maxent output
maxent_quarter_4 <- raster("/capstone/kelpgeomod/new_file_structure/03-analysis-data/maxent/quarter_4/results/Macrocystis_pyrifera_cloglog.tif")
...
This map has layers that can be toggled on and off. Each grid cell per layer is a measure of kelp habitat suitability for that quarter.
...
This map shows the mean predicted habitat suitability for grid cells that:
  ...
  3. Have a sandy-bottom substrate
