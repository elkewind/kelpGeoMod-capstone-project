...
idw_prep_year_quarters("nitrate_nitrite", nutrients)
idw_prep_year_quarters("ammonium", nutrients)
...
writeRaster(phosphate_idw_brick, "/capstone/kelpgeomod/old_file_structure/intermediate_data/joined_nutrients/phosphate_raster.tif", format = "GTiff")

writeRaster(nitrate_nitrite_idw_brick, "/capstone/kelpgeomod/old_file_structure/intermediate_data/joined_nutrients/nitrate_nitrite_raster.tif", format = "GTiff")

writeRaster(ammonium_idw_brick, "/capstone/kelpgeomod/old_file_structure/intermediate_data/joined_nutrients/ammonium_raster.tif", format = "GTiff")
```
