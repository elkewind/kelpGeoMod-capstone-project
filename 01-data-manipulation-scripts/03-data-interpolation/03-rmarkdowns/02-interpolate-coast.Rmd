...
nutrients <- read_csv("analysis_data/synthesized/observed-nutrients-synthesized.csv")|> 
  st_as_sf(coords = c("lon", "lat"), crs = st_crs(4326)) |> 
  filter(nutrient_source != "lter_nitrate")

# read in coast_mask ( this should probably move to where the other masks are.)
coast_mask <- rast("raw_data/interpolation_shapes/sbc_coast.tif")
...
write_csv(performance_df, "analysis_data/inteprolate_idw/idw_performance.csv")
...
# phosphate
writeRaster(phosphate_idw_brick, "analysis_data/inteprolate_idw/phosphate_quarterly.tif", format = "GTiff", overwrite = TRUE)
# nitrate_nitrite
writeRaster(nitrate_nitrite_idw_brick, "analysis_data/inteprolate_idw/nitrate_nitrite_quarterly.tif", format = "GTiff", overwrite = TRUE)
# ammonium
writeRaster(ammonium_idw_brick, "analysis_data/inteprolate_idw/ammonium_quarterly.tif", format = "GTiff", overwrite = TRUE)
```


```{r label = "write individual files"}
# phosphate
terra::writeRaster(phosphate_interpolation[[1]], "analysis_data/inteprolate_idw/phosphate/phosphate_1.tif", overwrite = TRUE)
terra::writeRaster(phosphate_interpolation[[2]], "analysis_data/inteprolate_idw/phosphate/phosphate_2.tif", overwrite = TRUE)
terra::writeRaster(phosphate_interpolation[[3]], "analysis_data/inteprolate_idw/phosphate/phosphate_3.tif", overwrite = TRUE)
terra::writeRaster(phosphate_interpolation[[4]], "analysis_data/inteprolate_idw/phosphate/phosphate_4.tif", overwrite = TRUE)
# nitrate_nitrite
