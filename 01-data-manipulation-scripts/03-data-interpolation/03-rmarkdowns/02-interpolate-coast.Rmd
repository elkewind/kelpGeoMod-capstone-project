...
# read in coast_mask
coast_mask <- rast("/capstone/kelpgeomod/raw_data/interpolation_shapes/sbc_coast.tif")

# read in coast polygon
coast_poly <- st_read("/capstone/kelpgeomod/raw_data/interpolation_shapes/sbc_coast.shp")
```
...
# nitrate_nitrite
terra::writeRaster(nitrate_nitrite_interpolation[[1]], "/capstone/kelpgeomod/analysis_data/inteprolate_idw/nitrate_nitrite/nitrtate_nitrite_1.tif", overwrite = TRUE)
terra::writeRaster(nitrate_nitrite_interpolation[[2]], "/capstone/kelpgeomod/analysis_data/inteprolate_idw/nitrate_nitrite/nitrtate_nitrite_2.tif", overwrite = TRUE)
terra::writeRaster(nitrate_nitrite_interpolation[[3]], "/capstone/kelpgeomod/analysis_data/inteprolate_idw/nitrate_nitrite/nitrtate_nitrite_3.tif", overwrite = TRUE)
terra::writeRaster(nitrate_nitrite_interpolation[[4]], "/capstone/kelpgeomod/analysis_data/inteprolate_idw/nitrate_nitrite/nitrtate_nitrite_4.tif", overwrite = TRUE)
# ammonium
