...
# if running locally
#datadir <- "/Users/jfrench/Documents/MEDS/Capstone/DATA/Nutrients/plumes_blooms"

# if running on tsosie
datadir <- "/capstone/kelpgeomod/raw_data/"
```
...
file_names <- list.files(file.path(datadir, "plumes_and_blooms"))
...
### Convert lat lon to geomertry

```{r label = "Convert geometry"}

# convert lat and lon to geometry
PB_mean_geom <- PB_mean |> 
  mutate("Lon" = -Lon) |> 
...
```{r label = "write to RDS file"}
# if running locally
#write_rds(PB_mean_geom, "/Users/jfrench/Documents/MEDS/Capstone/Intermediate_data/Plumes_Blooms/Plumes_Blooms.RDS")

# if running on tsosie
write_rds(PB_mean_geom, "/capstone/kelpgeomod/intermediate_data/Plumes_Blooms/Plumes_Blooms.RDS")
```

```{r label = "Write to CSV"}
# write the full data frame to csv, will lose date and geom.

write_csv(PB_mean_geom, "/Users/jfrench/Documents/MEDS/Capstone/Intermediate_data/Plumes_Blooms/Plumes_Blooms.CSV")
```
