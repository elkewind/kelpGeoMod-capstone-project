...
# CalCOFI
calCOFI <- read_csv(file.path(data_dir, "02-intermediate-data/09-nutrients-intermediate/unjoined/calcofi.RDS")) |> 
...
USGS <- read_csv(file.path(data_dir, "02-intermediate-data/09-nutrients-intermediate/unjoined/usgs.rds")) |> 
  mutate("source" = "USGS") |> 
  st_as_sf(coords = c("lon", "lat"))
