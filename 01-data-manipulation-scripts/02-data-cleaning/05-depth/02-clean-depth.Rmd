...
```{r}
# Read in mask
mask <- terra::rast("mask/mask_rast.tif")
plot(mask)
```

```{r}
# Read in depth data
depth_dat <- terra::rast("/capstone/kelpgeomod/raw_data/depth/depth_long.tiff")
...
geoid1 <- terra::rast("/capstone/kelpgeomod/raw_data/depth/ETOPO_2022_v1_15s_N45W135_geoid.tif") # left tile
...
geoid2 <- terra::rast("/capstone/kelpgeomod/raw_data/depth/ETOPO_2022_v1_15s_N45W120_geoid.tif") # right tile
...
terra::writeRaster(resampled_depth, "/capstone/kelpgeomod/intermediate_data/depth/SBC_depth.tif", filetype = "GTiff", overwrite = TRUE)
```
