...
# If working locally 
#setwd("/Users/jfrench/Documents/MEDS/Capstone/DATA/Benthic_Habitat_2/USGS_shape_files/USGS_Coast_shape_files") 

# If working on tsosie
setwd("/capstone/kelpgeomod/old_file_structure/raw_data/Benthic_Habitat_2/USGS_shape_files/USGS_Coast_shape_files")
```
...
st_write(SB_coast, "/capstone/kelpgeomod/new_file_structure/02-intermediate-data/substrate/usgs_substrate_shape/usgs_substrate.shp")
```
...
# This is causing a package issue on tsosie but works locally. 
...
terra::writeRaster(usgs_raster, "/capstone/kelpgeomod/intermediate_data/substrate/usgs_substrate.tif", filetype = "GTiff", overwrite = TRUE)
```
