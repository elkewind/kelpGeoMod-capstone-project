...
setwd("/capstone/kelpgeomod/raw_data/Benthic_Habitat_2/Habitat_tiffs/Channel_Islands")
```
...
terra::writeRaster(CA_substrate_islands, "/capstone/kelpgeomod/intermediate_data/substrate/CA_maps_substrate_islands.tif", filetype = "GTiff", overwrite = TRUE)
```
